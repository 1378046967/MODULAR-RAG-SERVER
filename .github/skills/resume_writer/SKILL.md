...
1. 读取 `.github/skills/resume_writer/references/resume_principles.md` — 四段式结构、技术标签、亮点挖掘策略、常见误区
2. 读取 `.github/skills/resume_writer/references/project_highlights.md` — 10 大技术亮点（含话术方向和量化角度）
3. 按需深读 `DEV_SPEC.md` 对应章节或源码补充模块细节

### Phase 2: 用户画像采集

用 `ask_questions`（若有）或对话方式一次性收集（最多 4 个问题）：
